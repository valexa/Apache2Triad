    ...
    <TR>
      <TD width="995">
         <blockquote>
          <blockquote>
            <p>&nbsp;</p>
            <p><font size="4" face="Georgia, Times New Roman, Times, serif"><b>FAQ</b>
(Frequently Asked Questions)            </font>
</p>
            <p>
              <?php
require('http://apache2triad.net/post2faq.php');
?>
            </p>
            <p>&nbsp;            </p>
            </blockquote>
